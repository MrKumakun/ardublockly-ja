...
Blockly.Msg.AUTH = "このアプリを認証してください。データを保存して共有することができます。";
...
Blockly.Msg.CONTROLS_FOR_TITLE = "　 %1 が %2 から %3 になるまで %4 を加えて繰返す";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "成立しなければ、繰り返す";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "成立する間、繰り返す";
...
Blockly.Msg.INTERRUPTS_ATTACH_TITLE = "割り込みを設定";
Blockly.Msg.INTERRUPTS_ATTACH_TOOLTIP = "割り込み番号(PIN)からの割り込みを受け付けます";
Blockly.Msg.INTERRUPTS_DETACH_HELPURL = "https://www.arduino.cc/en/Reference/DetachInterrupt";  // untranslated
Blockly.Msg.INTERRUPTS_DETACH_TITLE = "割り込みを解除";
Blockly.Msg.INTERRUPTS_DETACH_TOOLTIP = "割り込み番号(PIN)からの割り込みを停止します";
...
Blockly.Msg.INTERRUPTS_NO_TITLE = "割り込みを禁止";
Blockly.Msg.INTERRUPTS_NO_TOOLTIP = "割り込みを無効にします (interrupts() を使用して再度有効にすることができます)";
Blockly.Msg.INTERRUPTS_TITLE = "割り込みを許可";
Blockly.Msg.INTERRUPTS_TOOLTIP = "割り込みを再度有効にします (noInterrupts() を使用して無効になっている場合)。";
...
Blockly.Msg.LISTS_SORT_TITLE = "整列 %1 %2 %3";
Blockly.Msg.LISTS_SORT_TOOLTIP = "リストを順番に整列します.";
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE = "文字列(大文字と小文字の区別なし)";
Blockly.Msg.LISTS_SORT_TYPE_NUMERIC = "数字";
Blockly.Msg.LISTS_SORT_TYPE_TEXT = "文字列";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN = "リストの内容を区切り文字を入れて連結します";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT = "テキストを区切り文字で分割します";
Blockly.Msg.LISTS_SPLIT_WITH_DELIMITER = "区切り文字";
...
Blockly.Msg.MATH_ANG_DEG = "角度(angle)";
Blockly.Msg.MATH_ANG_RAD = "弧度(radian)";
Blockly.Msg.MATH_ANG_TOOLTIP_DEG = "弧度(radian)を角度(angle)に変換します。radian(ラジアン)とは角の大きさを表す単位の 1 つです。";
Blockly.Msg.MATH_ANG_TOOLTIP_RAD = "角度(angle)を弧度(radian)に変換します。radian(ラジアン)とは角の大きさを表す単位の 1 つです。";
...
Blockly.Msg.MATH_IS_DIVISIBLE_BY = "は割り切れる";
Blockly.Msg.MATH_IS_EVEN = "は偶数です";
Blockly.Msg.MATH_IS_NEGATIVE = "は負の値です";
Blockly.Msg.MATH_IS_ODD = "は奇数です";
Blockly.Msg.MATH_IS_POSITIVE = "は正の値です";
Blockly.Msg.MATH_IS_PRIME = "は素数です";
...
Blockly.Msg.MATH_IS_WHOLE = "は整数です";
...
Blockly.Msg.MATH_RANDOM_INT_TITLE = "%1 から %2 までの乱数(整数値)";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "指定した間の、無作為なランダムな整数を返します。";
...
Blockly.Msg.PROCEDURES_ALLOW_STATEMENTS = "ステートメントの許可";
Blockly.Msg.PROCEDURES_BEFORE_PARAMS = ", 引数は(";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "ユーザー定義関数 '%1' を実行し、その戻り値を取得します。";
Blockly.Msg.PROCEDURES_CALL_BEFORE_PARAMS = "を実行。引数は、";
Blockly.Msg.PROCEDURES_CREATE_DO = "%1をつくる";
Blockly.Msg.PROCEDURES_DEFNORETURN_COMMENT = "このサブルーチンの説明を記述します";
Blockly.Msg.PROCEDURES_DEFNORETURN_DO = "";
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL = "https://ja.wikipedia.org/wiki/サブルーチン";
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "Hoge";
...
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "戻り値は";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP = "関数に入力を追加";
...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "アナログ値の入力 pin#";
Blockly.Msg.ARD_ANALOGREAD_TIP = "0 から 1024 の間の値を返します";
Blockly.Msg.ARD_ANALOGWRITE = "アナログ値の出力 pin#";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "0 から 255 の間のアナログ値を特定のPWMポートに書き込む";
Blockly.Msg.ARD_BUILTIN_LED = "組込みLEDを指定";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Arduinoに付属のLEDをオンまたはオフにします";
Blockly.Msg.ARD_CHANGE = "↑↓ 変化";
Blockly.Msg.ARD_COMPONENT_WARN1 = "このブロックを使用するには、同じ %2 を持つ %1 構成ブロックを追加する必要があります";
Blockly.Msg.ARD_DEFINE = "Define";
Blockly.Msg.ARD_DIGITALREAD = "デジタル値の入力 pin#";
Blockly.Msg.ARD_DIGITALREAD_TIP = "ピンの HIGH もしくは LOW を読み込みます";
Blockly.Msg.ARD_DIGITALWRITE = "デジタル値の出力 pin#";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "特定のポートを High もしくは Low に設定します";
Blockly.Msg.ARD_FALLING = " ↓　立下り";
Blockly.Msg.ARD_FUN_RUN_LOOP = "メインループ - loop";
Blockly.Msg.ARD_FUN_RUN_SETUP = "セットアップ - setup";
Blockly.Msg.ARD_FUN_RUN_TIP = "Arduino が定義する setup() と loop() の処理です";
Blockly.Msg.ARD_HIGH = "HIGH";
Blockly.Msg.ARD_HIGHLOW_TIP = "ピンの出力を High もしくは Low に設定します";
Blockly.Msg.ARD_LOW = "LOW";
Blockly.Msg.ARD_MAP = "Map";
Blockly.Msg.ARD_MAP_TIP = "[0-1024] の間に再マッピングします.";
Blockly.Msg.ARD_MAP_VAL = " を 0 から ";
Blockly.Msg.ARD_MAP_VAL_END = " までの値に変換します";
Blockly.Msg.ARD_NOTONE = "トーンの出力を停止 pin #";
Blockly.Msg.ARD_NOTONE_PIN = "No tone PIN#";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "オーディオトーンを停止します";
Blockly.Msg.ARD_NOTONE_TIP = "選択したピンのトーンをオフにします";
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 が %2 として pin %3 を必要としていますが、すでに %4 として利用されています。";
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "マイクロ秒単位でタイムアウトする場合のみ、選択したピンのパルスの持続時間を測定します";
Blockly.Msg.ARD_PULSE_READ = "pin# %2 で %1 のパルスを測定します";
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "%3 μsを待った後に、pin# %2 で %1 のパルスを測定します";
Blockly.Msg.ARD_PULSE_TIP = "選択したピンのパルスの持続時間を測定します";
Blockly.Msg.ARD_RISING = " ↑　立上り";
Blockly.Msg.ARD_SERIAL_BPS = "bps";
Blockly.Msg.ARD_SERIAL_PRINT = "に文字を出力";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "改行";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "読取り可能なASCIIテキストとしてデータをコンソール/シリアルポートに出力します";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "このブロックを使用するには、%1 のセットアップブロックをワークスペースに追加する必要があります";
Blockly.Msg.ARD_SERIAL_SETUP = "";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "シリアル通信の同期速度を選択します";
Blockly.Msg.ARD_SERIAL_SPEED = " を初期化します。通信速度は ";
Blockly.Msg.ARD_SERVO_READ = "サーボモータの角度の読込み pin#";
Blockly.Msg.ARD_SERVO_READ_TIP = "サーボの角度を読み出します";
Blockly.Msg.ARD_SERVO_WRITE = "サーボモーター pin#";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "度(0~180)にする";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "指定された角度にサーボを設定します";
Blockly.Msg.ARD_SERVO_WRITE_TO = "を";
Blockly.Msg.ARD_SETTONE = "トーンを出力 pin #";
Blockly.Msg.ARD_SPI_SETUP = "";
Blockly.Msg.ARD_SPI_SETUP_CONF = "通信の構成:";
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "クロック分割";
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPIモード (idle - edge)";
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (Low - ↓ 立ち下がり)";
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (Low - ↑ 立ち上がり)";
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (High - ↓ 立ち下がり)";
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (High - ↑ 立ち上がり)";
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "MSBFIRST";
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "ビット出力方向";
Blockly.Msg.ARD_SPI_SETUP_TIP = "SPI周辺機器を構成します";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "指定されたデバイスにSPIメッセージを送信し、データを取得します。";
Blockly.Msg.ARD_SPI_TRANS_NONE = "none";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "を移転します。接続デバイスは pin#";
Blockly.Msg.ARD_SPI_TRANS_TIP = "指定されたデバイスにSPIメッセージを送信します";
Blockly.Msg.ARD_SPI_TRANS_VAL = "に";
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "このブロックを使用するには、%1 のセットアップブロックをワークスペースに追加する必要があります";
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "古いpin# %1 は利用できなくなりました";
...
Blockly.Msg.ARD_STEPPER_MOTOR = "ステッピングモーター:";
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "接続されているピンの数は ";
...
Blockly.Msg.ARD_STEPPER_REVOLVS = "１段階あたりのステップ数";
Blockly.Msg.ARD_STEPPER_SETUP = "ステッピングモーターのセットアップ";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "ステッピングモーターのピンとその他の設定を構成します。";
Blockly.Msg.ARD_STEPPER_SPEED = "速度(rpm)は ";
Blockly.Msg.ARD_STEPPER_STEP = "モーターを";
Blockly.Msg.ARD_STEPPER_STEPS = "ステップ 動かす";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "ステッピングモーターを指定の数だけ動かします";
Blockly.Msg.ARD_STEPPER_TWO_PINS = "2";
Blockly.Msg.ARD_TIME_DELAY = "待機";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "マイクロ秒";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "マイクロ秒単位で待ちます";
Blockly.Msg.ARD_TIME_DELAY_TIP = "ミリ秒単位で待ちます";
Blockly.Msg.ARD_TIME_INF = "停止 (無限ループ)";
Blockly.Msg.ARD_TIME_INF_TIP = "プログラムが停止します。CPUがビジー状態になるので注意が必要です。割込みは動作します";
Blockly.Msg.ARD_TIME_MICROS = "現在の経過時間(マイクロ秒)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "Arduino ボードが現在のプログラムの実行を開始してからのマイクロ秒数を返します。longで格納する必要があります";
Blockly.Msg.ARD_TIME_MILLIS = "現在の経過時間(ミリ秒)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Arduino ボードが現在のプログラムの実行を開始してからのミリ秒数を返します。longで格納する必要があります";
Blockly.Msg.ARD_TIME_MS = "ミリ秒";
Blockly.Msg.ARD_TONEFREQ = "、周波数は";
Blockly.Msg.ARD_TONE_FREQ = "周波数";
Blockly.Msg.ARD_TONE_PIN = "Tone PIN#";
Blockly.Msg.ARD_TONE_PIN_TIP = "オーディオトーンを生成して出力します";
Blockly.Msg.ARD_TONE_TIP = "ピンの出力を、トーン 31 ～ 65535 の範囲内の指定された周波数に設定します";
Blockly.Msg.ARD_TONE_WARNING = "周波数は 31 ～ 65535 の範囲内である必要があります";
Blockly.Msg.ARD_TYPE_ARRAY = "配列";
Blockly.Msg.ARD_TYPE_BOOL = "論理型";
Blockly.Msg.ARD_TYPE_CHAR = "1つの文字";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "下位ブロックの不一致";
Blockly.Msg.ARD_TYPE_DECIMAL = "浮動小数点";
Blockly.Msg.ARD_TYPE_LONG = "大きな数字(32bit)";
Blockly.Msg.ARD_TYPE_NULL = "Null";
Blockly.Msg.ARD_TYPE_NUMBER = "数字(16bit)";
Blockly.Msg.ARD_TYPE_SHORT = "小さな数字(8bit)";
Blockly.Msg.ARD_TYPE_TEXT = "テキスト";
Blockly.Msg.ARD_TYPE_UNDEF = "未定義";
Blockly.Msg.ARD_VAR_AS = "は、";
Blockly.Msg.ARD_VAR_AS_TIP = "特定のタイプに値を設定します";
Blockly.Msg.ARD_WRITE_TO = "to";
Blockly.Msg.NEW_INSTANCE = "インスタンスを作成中...";
Blockly.Msg.NEW_INSTANCE_TITLE = "新しいインスタンスの名前:";
Blockly.Msg.RENAME_INSTANCE = "インスタンス名の変更中...";
Blockly.Msg.RENAME_INSTANCE_TITLE = "すべての '%1' インスタンスの名前を変更します:";
